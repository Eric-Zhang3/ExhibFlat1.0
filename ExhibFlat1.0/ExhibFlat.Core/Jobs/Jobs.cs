namespace ExhibFlat.Core.Jobs
{
    ...
    public class Jobs : IDisposable
    {
        ...
        private static readonly ExhibFlat.Core.Jobs.Jobs _jobs = null;
        ...
        static Jobs()
        {
            _jobs = new ExhibFlat.Core.Jobs.Jobs();
        }
        ...
        public static ExhibFlat.Core.Jobs.Jobs Instance()
        {
            return _jobs;
        }
        ...
        public void Start()
        {
            ...
            lock (this.jobList.SyncRoot)
            {
                ...
                {
                    XmlNode configSection = HiConfiguration.GetConfig().GetConfigSection("ExhibFlat/Jobs");
                    bool flag = true;
