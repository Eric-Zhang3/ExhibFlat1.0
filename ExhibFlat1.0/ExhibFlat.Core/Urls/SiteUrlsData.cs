namespace ExhibFlat.Core.Urls
{
    ...
    public class SiteUrlsData
    {
        ...
        private ExhibFlat.Core.Urls.LocationSet _locationSet = null;
        ...
        private ExhibFlat.Core.Urls.LocationSet CreateLocationSet(XmlNode basePaths, string globalPath)
        {
            ExhibFlat.Core.Urls.LocationSet set = new ExhibFlat.Core.Urls.LocationSet();
        ...
        public ExhibFlat.Core.Urls.LocationSet LocationSet
        {
            get
            {
