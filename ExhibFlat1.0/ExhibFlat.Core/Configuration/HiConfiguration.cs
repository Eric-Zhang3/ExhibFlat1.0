namespace ExhibFlat.Core.Configuration
{
    ...
    public class HiConfiguration
    {
        ...
        private ExhibFlat.Core.Configuration.AppLocation app;
        ...
        private ExhibFlat.Core.Configuration.RolesConfiguration roleConfiguration;
        ...
        private string usernameRegex = "[一-龥a-zA-Z]+[一-龥_a-zA-Z0-9]*";
        ...
        public static HiConfiguration GetConfig()
        {
            ...
            if (configuration == null)
            {
                ...
                if (current != null)
                {
                    filename = current.Request.MapPath("~/config/ExhibFlat.config");
                }
                else
                {
                    filename = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"config\ExhibFlat.config");
                }
        ...
        public ExhibFlat.Core.Configuration.AppLocation AppLocation
        {
            get
            {
                return this.app;
        ...
        public ExhibFlat.Core.Configuration.RolesConfiguration RolesConfiguration
        {
            get
            {
