namespace ExhibFlat.Core
{
    ...
    public static class Globals
    {
        ...
        public static string HostPath(Uri uri)
        {
            ...
            //return string.Format(CultureInfo.InvariantCulture, "{0}://{1}{2}", new object[] { uri.Scheme, uri.Host, str });  去掉端口
            return string.Format(CultureInfo.InvariantCulture, "{0}://{1}", new object[] { uri.Scheme, uri.Host });
        }
