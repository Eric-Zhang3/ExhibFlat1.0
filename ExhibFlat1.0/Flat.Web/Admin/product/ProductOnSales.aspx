    ...
    <script type="text/javascript">
        ...
        function PenetrationStatus() {
            ...
            if (productIds.length > 0) {
                formtype = "unsale";
                arrytext = null;
                DialogShow("商品下架", "productunsale", "UnSaleProduct", "contentHolder_btnOK");
            }
        }
        ...
        function StockStatus() {
            ...
            if (productIds.length > 0) {
                formtype = "instock";
                arrytext = null;
                DialogShow("商品入库", "productinstock", "InStockProduct", "contentHolder_btnStockPentrationStauts");
            }
        ...
        function EditProdcutTag() {
            ...
            if (productIds.length > 0) {
                ...
                DialogShow("商品标签", "producttag", "TagsProduct", "contentHolder_btnUpdateProductTags");
            }
