    ...
    $.ajax({
        ...
        success: function(resultData) {
            if (resultData.Status == "OK") {
                initPriceBox("编辑分销商价", "分销商等级", resultData.MemberGrades, basePrice);
            }
        }
    });
}
...
function initPriceBox(title, gradeTitle, gradeList, basePrice) {
    ...
    var priceTable = $("<table id=\"priceTable\" width=\"100%\" border=\"0\" cellSpacing=\"0\" cellPadding=\"2\" class=\"gradePriceTable\"><\/table>");
