...
function Calendar(e, gtToday, clickbefcallback, clickaftcallback, beginYear, endYear, language, patternDelimiter, date2StringPattern, string2DatePattern) {
    e = window.event || e;
    this.eventSrc = e.srcElement || e.target;
    this.gtToday = gtToday || 0; //by Yongjin.C
    this.clickbefcallback = clickbefcallback || function() { return true; };
    this.clickaftcallback = clickaftcallback || function() { return true; };
...
Calendar.prototype.draw = function() {
    ...
    this.form.selectTodayButton.onclick = function() {
        ...
        var fool = calendar.clickbefcallback(new Date(calendar.date.getFullYear(), calendar.date.getMonth(), this.innerHTML).format(calendar.date2StringPattern));
        if (fool)
...
Calendar.prototype.show = function(dateControl, popuControl) {
    ...
    if (dateControl.value.length > 0) {
        this.preDateStr = dateControl.value;
...
Calendar.prototype.hide = function() {
    this.panel.style.display = "none";
    this.clickaftcallback(calendar.dateControl.value);
};
...
Calendar.prototype.getAbsPoint = function(e) {
    //  var style = /^auto|scroll$/i;
    var x = e.offsetLeft;
    var y = e.offsetTop;
    while (e = e.offsetParent) {
        // if (e.style.position == 'absolute' || e.style.position == 'relative') { //|| (e.style.overflow != 'visible' && e.style.overflow != '')) {
        // if (style.test(e.style.overflow) || style.test(e.style.overflowX) || style.test(e.style.overflowY)) { //修复overflow auto 移位问题
...
///0,1,2
function AddCalendar(e, obj, gtorlttoday, clickbefcallback, clickaftcallback) {
    //By yongjin.C

    var b = gtorlttoday != null ? gtorlttoday : 1;
    calendar = new Calendar(e, b, clickbefcallback, clickaftcallback, '2007', '2020', 0, '-', 'yyyy-MM-dd');
