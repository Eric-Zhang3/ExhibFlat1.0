...
function PageIsValid() {
  /* var isValid = true;
    ...
    ctls.each(function(){       
       ...
       {    
           for( var i = 0 ; i < $( "#"+this["id"] ).get(0).validator.length; i++ ){
               if ($("#ctl00_contentHolder_chkSkuEnabled").attr("checked") == "checked" && ($("#" + this["id"]).get(0).validator[i]._ValidateTargetId != "ctl00_contentHolder_txtSalePrice"
                   || $("#" + this["id"]).get(0).validator[i]._ValidateTargetId != "ctl00_contentHolder_txtCostPrice"
                   || $("#" + this["id"]).get(0).validator[i]._ValidateTargetId != "ctl00_contentHolder_txtPurchasePrice"
                   || $("#" + this["id"]).get(0).validator[i]._ValidateTargetId != "ctl00_contentHolder_txtStock"
                   || $("#" + this["id"]).get(0).validator[i]._ValidateTargetId != "ctl00_contentHolder_txtWeight"))
               { 
                   continue;
               }
              if($("#" + this["id"]).get(0).validator[i]._IsValid == false)
