    ...
    public class SelectCategory : AdminPage
    {
        private void DoCallback()
        {
            ...
            if (str.Equals("getlist"))
            {
                ...
                IList<CategoryInfo> categories = (result == 0) ? ProductHelper.GetMainCategories() : ProductHelper.SearchCategories(result, null);
            ...
            else if (str.Equals("getinfo"))
            {
                ...
                {
                    CategoryInfo category = ProductHelper.GetCategory(num2);
                    if (category == null)
                    {
                        base.Response.Write("{\"Status\":\"0\"}");
                    }
