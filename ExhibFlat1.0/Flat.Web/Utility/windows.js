...
function divOpen(objDiv,divWidth,divHeight){
		...
		$("#" + objDiv).css("border", "solid 1px #a3a3a3");
		$("#" + objDiv).css({"border-radius":"3px","-webkit-border-radius":"3px","-moz-border-radius":"3px"});
}
