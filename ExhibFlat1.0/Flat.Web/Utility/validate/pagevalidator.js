...
function PageIsValidSupplier() {
    var isValid = true;
    var username = $("#SupplierRegisters_txtUserNameTip").text();
    var email = $("#SupplierRegisters_txtEmailTip").text();
    var pwd = $("#SupplierRegisters_txtPasswordTip").text();
    var repwd = $("# SupplierRegisters_txtPasswordCompareTip").text();
    var code = $("#SupplierRegisters_txtZipcodeTip").text();
    var tel = $("#SupplierRegisters_txtTelPhoneTip").text();
    var cell = $("#SupplierRegisters_txtCellPhoneTip").text();
    var msn = $("#SupplierRegisters_txtMSNTip").text();
