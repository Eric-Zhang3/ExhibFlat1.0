        ...
        $.post("/API/CommonHandler.ashx?op=ShoppingCar", {}, function(d) {
            ...
            if (!!data) {
                $.each(data, function(i, content) {
                    if (i == 0) {
                        $(".cartInner").append($("<p>最近加入的商品：</p>"));
                    }
                    var productname = content.Name.length > 2 ? content.Name.substring(0, 2) + "..." : content.Name;
                    var item = $("<dl> <dt> <a href=/product_detail-" + content.ProductId + ".htm><img src='" + content.ThumbnailUrl60 + "' style='width:40px;height:40px'/></a> <em>×" + content.Quantity + "</em> </dt> <dd> <strong><em>￥</em>" + content.MemberPrice + "/件</strong><p><a href='#' onclick='DeleteShoppingCart(\"" + content.SkuId + "\")'>删除</a></p> </dd> </dl>");
