...
function error(code, stop) {
	var msg = 'Highcharts error #' + code + ': www./errors/' + code;
	if (stop) {
		throw msg;
	} else if (win.console) {
		console.log(msg);
...
defaultOptions = {
	...
	global: {
		useUTC: true,
		//timezoneOffset: 0,
		canvasToolsURL: 'http://code./3.0.10/modules/canvas-tools.js',
		VMLRadialGradientURL: 'http://code./3.0.10/gfx/vml-radial-gradient.png'
	},
	chart: {
		//animation: true,
		//alignTicks: false,
