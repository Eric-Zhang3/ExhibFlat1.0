namespace ExhibFlat.Membership.Context
{
    ...
    public sealed class HiContext
    {
        ...
        private ExhibFlat.Membership.Context.SiteSettings currentSettings;
        private const string dataKey = "ExhibFlat_ContextStore";
        ...
        public string GetStoragePath()
        {
            ...
            if (Current.ApplicationType == ExhibFlat.Core.Enums.ApplicationType.Distributor)
            {
                return ("/Storage/sites/" + Current.User.UserId.ToString(CultureInfo.InvariantCulture));
            }
        ...
        {
            context.Context.Items["ExhibFlat_ContextStore"] = context;
        }
        ...
        public static HiContext Current
        {
            get
            {
                ...
                HiContext context = current.Items["ExhibFlat_ContextStore"] as HiContext;
                if (context == null)
                {
                    if (current == null)
                    {
        ...
        public ExhibFlat.Membership.Context.SiteSettings SiteSettings
        {
            get
            {
