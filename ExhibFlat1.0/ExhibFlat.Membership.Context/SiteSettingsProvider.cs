namespace ExhibFlat.Membership.Context
{
    ...
    {
        private static readonly SiteSettingsProvider _defaultInstance = (DataProviders.CreateInstance("ExhibFlat.Membership.Data.SettingsData,ExhibFlat.Membership.Data") as SiteSettingsProvider);
