namespace ExhibFlat.Membership.Context
{
    ...
    public class SiteManager : IUser
    {
        public SiteManager()
        {
            this.MembershipUser = new HiMembershipUser(false, ExhibFlat.Membership.Core.Enums.UserRole.SiteManager);
        }
        ...
        public bool IsAdministrator
        {
            get
            {
                try
                {
                    ...
                    return this.IsInRole(rolesConfiguration.SystemAdministrator);
                }
                catch
                {
                }
