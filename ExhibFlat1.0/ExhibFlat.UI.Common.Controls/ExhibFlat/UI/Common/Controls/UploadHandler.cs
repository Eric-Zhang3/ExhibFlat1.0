namespace ExhibFlat.UI.Common.Controls
{
    ...
    public class UploadHandler : IHttpHandler
    {
        ...
        private void DoDelete(HttpContext context)
        {
            ...
            string path = context.Request.MapPath(Globals.ApplicationPath + context.Request.Form[this.uploaderId + "_uploadedImageUrl"].Replace(IMAGEURL,""));
        ...
        private void UploadImage(HttpContext context, HttpPostedFile file)
        {
            ...
            ResourcesHelper.CreateThumbnail(sourceFilename, context.Request.MapPath(Globals.ApplicationPath + str7), 226, 226);
            ...
            ResourcesHelper.CreateThumbnail(sourceFilename, context.Request.MapPath(Globals.ApplicationPath + str11), 700, 700);
