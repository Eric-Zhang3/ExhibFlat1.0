namespace ExhibFlat.UI.Common.Controls
{
    ...
    public class ImageLinkButton : LinkButton
    {
        ...
        private bool isShow;
        private ExhibFlat.UI.Common.Controls.ImagePosition position;
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            if (this.ImagePosition == ExhibFlat.UI.Common.Controls.ImagePosition.Right)
            {
        ...
        public ExhibFlat.UI.Common.Controls.ImagePosition ImagePosition
        {
            get
            {
