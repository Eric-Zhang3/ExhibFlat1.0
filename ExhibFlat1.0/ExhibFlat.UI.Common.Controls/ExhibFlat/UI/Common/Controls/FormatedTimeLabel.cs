namespace ExhibFlat.UI.Common.Controls
{
    ...
    public class FormatedTimeLabel : Literal
    {
        ...
        {
            if (((this.Time == null) || (this.Time == DBNull.Value)) || (Convert.ToDateTime((DateTime)this.Time, CultureInfo.InvariantCulture) == DateTime.MinValue) || Convert.ToString((DateTime)this.Time, CultureInfo.InvariantCulture) == "01/01/1900 00:00:00")
            {
