namespace ExhibFlat.Membership.Data
{
    ...
    public class BizActorData : BizActorProvider
    {
        ...
        private bool ChangeTradePassword(string tableName, string username, string oldPassword, string newPassword)
        {
            ...
            if ((provider.PasswordStrengthRegularExpression.Length > 0) &&
                !Regex.IsMatch(newPassword, provider.PasswordStrengthRegularExpression))
            {
                return false;
            }
            ...
            DbCommand sqlStringCommand =
                this.database.GetSqlStringCommand("UPDATE " + tableName +
                                                  " SET TradePassword = @TradePassword, TradePasswordSalt = @TradePasswordSalt, TradePasswordFormat = @TradePasswordFormat WHERE UserId = (SELECT UserId FROM aspnet_Users WHERE LOWER(@Username) = LoweredUserName)");
        ...
        private bool CheckTradePassword(string tableName, string username, string password, out string salt,
        ...
        public override bool CreateDistributor(Distributor distributor)
        {
            ...
            this.database.AddInParameter(sqlStringCommand, "TradePassword", DbType.String,
                UserHelper.EncodePassword(distributor.TradePasswordFormat, distributor.TradePassword, salt));
            this.database.AddInParameter(sqlStringCommand, "TradePasswordSalt", DbType.String, salt);
            this.database.AddInParameter(sqlStringCommand, "TradePasswordFormat", DbType.Int32,
                distributor.TradePasswordFormat);
        ...
        //添加供应商
        public override bool CreateSupplier(Supplier supplier)
        {
            DbCommand sqlStringCommand =
                this.database.GetSqlStringCommand(
                    "INSERT INTO Hishop_Suppliers (UserId, GradeId,SupplierId,TopRegionId, RegionId, SupplierName,RealName,CompanyName, Address,  BankCode, TelPhone, CellPhone, Remark,Businesslicense,Shuiwu,Zuzhijg,BnessCode,ShuiwuCode,ZuzhijgCode,BankName,Supplierpwd,ThreeCertificateImg,RequestRole,RequestCode,ApplyDate,Zipcode) VALUES (@UserId, @GradeId,@SupplierId, @TopRegionId, @RegionId,@SupplierName, @RealName,@CompanyName, @Address,@Bankcode, @TelPhone, @CellPhone, @Remark,@Businesslicense,@Shuiwu,@Zuzhijg,@BnessCode,@ShuiwuCode,@ZuzhijgCode,@BankName,@Supplierpwd,@ThreeCertificateImg,@RequestRole,@RequestCode,@ApplyDate,@Zipcode)");
            string salt = UserHelper.CreateSalt();
            this.database.AddInParameter(sqlStringCommand, "UserId", DbType.Int32, supplier.UserId);
            this.database.AddInParameter(sqlStringCommand, "GradeId", DbType.Int32, supplier.GradeId);
            this.database.AddInParameter(sqlStringCommand, "SupplierId", DbType.String, supplier.SupplierId);
            this.database.AddInParameter(sqlStringCommand, "TopRegionId", DbType.Int32, supplier.TopRegionId);
            this.database.AddInParameter(sqlStringCommand, "RegionId", DbType.Int32, supplier.RegionId);
            this.database.AddInParameter(sqlStringCommand, "SupplierName", DbType.String, supplier.Username);
            this.database.AddInParameter(sqlStringCommand, "RealName", DbType.String, supplier.RealName);
            this.database.AddInParameter(sqlStringCommand, "CompanyName", DbType.String, supplier.CompanyName);
            this.database.AddInParameter(sqlStringCommand, "Address", DbType.String, supplier.Address);
            this.database.AddInParameter(sqlStringCommand, "Bankcode", DbType.String, supplier.BankCode);
            this.database.AddInParameter(sqlStringCommand, "BankName", DbType.String, supplier.BankName);
            this.database.AddInParameter(sqlStringCommand, "TelPhone", DbType.String, supplier.TelPhone);
            this.database.AddInParameter(sqlStringCommand, "CellPhone", DbType.String, supplier.CellPhone);
            this.database.AddInParameter(sqlStringCommand, "Remark", DbType.String, supplier.Remark);
            this.database.AddInParameter(sqlStringCommand, "Businesslicense", DbType.String, supplier.Businesslicense);
            this.database.AddInParameter(sqlStringCommand, "Shuiwu", DbType.String, supplier.Shuiwu);
            this.database.AddInParameter(sqlStringCommand, "Zuzhijg", DbType.String, supplier.Zuzhijg);
            this.database.AddInParameter(sqlStringCommand, "BnessCode", DbType.String, supplier.BnessCode);
            this.database.AddInParameter(sqlStringCommand, "ShuiwuCode", DbType.String, supplier.ShuiwuCode);
            this.database.AddInParameter(sqlStringCommand, "ZuzhijgCode", DbType.String, supplier.ZuzhijgCode);
            this.database.AddInParameter(sqlStringCommand, "Supplierpwd", DbType.String, supplier.Supplierpwd);
            this.database.AddInParameter(sqlStringCommand, "ThreeCertificateImg", DbType.String,
                supplier.ThreeCertificateImg);
            this.database.AddInParameter(sqlStringCommand, "RequestRole", DbType.Int32,
                supplier.RequestRole);
            this.database.AddInParameter(sqlStringCommand, "RequestCode", DbType.String,
                supplier.RequestCode);
            this.database.AddInParameter(sqlStringCommand, "ApplyDate", DbType.DateTime,
                supplier.ApplyDate);
            this.database.AddInParameter(sqlStringCommand, "Zipcode", DbType.String,
                supplier.Zipcode);
            return (this.database.ExecuteNonQuery(sqlStringCommand) == 1);
        }
        /// <summary>
        /// 添加联盟商户
        /// </summary>
        public bool CreateSupplier_Yi_Union(Supplier supplier)
        {
            DbCommand sqlStringCommand =
                this.database.GetSqlStringCommand(
                    "INSERT INTO Hishop_Suppliers (UserId, GradeId,SupplierId,TopRegionId, RegionId, SupplierName,RealName,CompanyName, Address,  BankCode, TelPhone, CellPhone, Remark,Businesslicense,Shuiwu,Zuzhijg,BnessCode,ShuiwuCode,ZuzhijgCode,BankName,Supplierpwd,ThreeCertificateImg,RequestRole,RequestCode,ApplyDate,IdentityCardNum,IdentityCardImg,ShopTitleImg,ShopInnerImg,Zipcode) VALUES (@UserId, @GradeId,@SupplierId, @TopRegionId, @RegionId,@SupplierName, @RealName,@CompanyName, @Address,@Bankcode, @TelPhone, @CellPhone, @Remark,@Businesslicense,@Shuiwu,@Zuzhijg,@BnessCode,@ShuiwuCode,@ZuzhijgCode,@BankName,@Supplierpwd,@ThreeCertificateImg,@RequestRole,@RequestCode,@ApplyDate,@IdentityCardNum,@IdentityCardImg,@ShopTitleImg,@ShopInnerImg,@Zipcode)");
            string salt = UserHelper.CreateSalt();
            this.database.AddInParameter(sqlStringCommand, "UserId", DbType.Int32, supplier.UserId);
            this.database.AddInParameter(sqlStringCommand, "GradeId", DbType.Int32, supplier.GradeId);
            this.database.AddInParameter(sqlStringCommand, "SupplierId", DbType.String, supplier.SupplierId);
            ...
            this.database.AddInParameter(sqlStringCommand, "ThreeCertificateImg", DbType.String,
                supplier.ThreeCertificateImg);
            this.database.AddInParameter(sqlStringCommand, "IdentityCardNum", DbType.String,
                supplier.IdentityCardNum);
            this.database.AddInParameter(sqlStringCommand, "IdentityCardImg", DbType.String,
                supplier.IdentityCardImg);
            this.database.AddInParameter(sqlStringCommand, "ShopTitleImg", DbType.String,
                supplier.ShopTitleImg);
            this.database.AddInParameter(sqlStringCommand, "ShopInnerImg", DbType.String,
                supplier.ShopInnerImg);
            this.database.AddInParameter(sqlStringCommand, "RequestRole", DbType.Int32,
                supplier.RequestRole);
            this.database.AddInParameter(sqlStringCommand, "RequestCode", DbType.String,
                supplier.RequestCode);
        ...
        //添加供应商
        public  bool CreateSupplier_Yi(Supplier supplier)
        {
            DbCommand sqlStringCommand =
                this.database.GetSqlStringCommand(
                    "INSERT INTO Hishop_Suppliers (UserId, GradeId,SupplierId,TopRegionId, RegionId, SupplierName,RealName,CompanyName, Address,  BankCode, TelPhone, CellPhone, Remark,Businesslicense,Shuiwu,Zuzhijg,BnessCode,ShuiwuCode,ZuzhijgCode,BankName,Supplierpwd,ThreeCertificateImg,RequestRole,RequestCode,ApplyDate,Zipcode) VALUES (@UserId, @GradeId,@SupplierId, @TopRegionId, @RegionId,@SupplierName, @RealName,@CompanyName, @Address,@Bankcode, @TelPhone, @CellPhone, @Remark,@Businesslicense,@Shuiwu,@Zuzhijg,@BnessCode,@ShuiwuCode,@ZuzhijgCode,@BankName,@Supplierpwd,@ThreeCertificateImg,@RequestRole,@RequestCode,@ApplyDate,@Zipcode)");
        ...
        {
            DbCommand sqlStringCommand =
                this.database.GetSqlStringCommand("INSERT INTO aspnet_Managers (UserId) VALUES (@UserId)");
        ...
        public override bool CreateMember(Member member)
        {
            try
            {
                DbCommand sqlStringCommand =
                        this.database.GetSqlStringCommand(
                            @"
                    if(exists(select 1 from aspnet_Members where UserId=@UserId))
                    begin
                        update aspnet_Members set GradeId=@GradeId, ReferralUserId=@ReferralUserId, TradePassword=@TradePassword,
                        TradePasswordSalt=@TradePasswordSalt, TradePasswordFormat=@TradePasswordFormat, OrderNumber=@OrderNumber, Expenditure=@Expenditure, Points=@Points, Balance=@Balance, TopRegionId=@TopRegionId, RegionId=@RegionId, RealName=@RealName, Address=@Address, Zipcode=@Zipcode, TelPhone=@TelPhone, CellPhone=@CellPhone, QQ=@QQ, Wangwang=@Wangwang, MSN=@MSN
                        where UserId=@UserId
                    end
                    else
                    begin
                ...
                this.database.AddInParameter(sqlStringCommand, "TradePassword", DbType.String,
                    UserHelper.EncodePassword(member.TradePasswordFormat, member.TradePassword, salt));
                this.database.AddInParameter(sqlStringCommand, "TradePasswordSalt", DbType.String, salt);
                this.database.AddInParameter(sqlStringCommand, "TradePasswordFormat", DbType.Int32,
                    member.TradePasswordFormat);
                ...
                DbCommand sqlStringCommand2 =
                       this.database.GetSqlStringCommand(
                           "Update aspnet_Users SET IsApproved=null where UserId=@UserId");
                this.database.AddInParameter(sqlStringCommand2, "UserId", DbType.Int32, member.UserId);
            ...
            {
                log.blog = true;
                log.GetInstance().writeLog("CreateMember() error: "+ex.Message);
                return false;
            }
        }
        ...
        public override bool CreateUnderling(Member underling)
        {
            ...
            this.database.AddInParameter(sqlStringCommand, "TradePassword", DbType.String,
                UserHelper.EncodePassword(underling.TradePasswordFormat, underling.TradePassword, salt));
            this.database.AddInParameter(sqlStringCommand, "TradePasswordSalt", DbType.String, salt);
            this.database.AddInParameter(sqlStringCommand, "TradePasswordFormat", DbType.Int32,
                underling.TradePasswordFormat);
        ...
        public override Distributor GetDistributor(HiMembershipUser membershipUser)
        {
            ...
            DbCommand sqlStringCommand =
                this.database.GetSqlStringCommand("SELECT * FROM aspnet_Distributors WHERE UserId = @UserId");
        ...
        //供应商
        public override Supplier GetSupplier(HiMembershipUser membershipUser)
        {
            Supplier supplier = null;
            DbCommand sqlStringCommand =
                this.database.GetSqlStringCommand(
                    "SELECT * FROM  dbo.aspnet_Users  A join  dbo.Hishop_Suppliers B on B.SupplierId=A.SupplierId WHERE A.UserName=@UserName ");

            this.database.AddInParameter(sqlStringCommand, "UserName", DbType.String, membershipUser.Username);
            using (IDataReader reader = this.database.ExecuteReader(sqlStringCommand))
            {
                if (!reader.Read())
                {
                ...
                supplier = new Supplier(membershipUser)
                {
                    GradeId = (int) reader["GradeId"],
                    MemberCount = (int) reader["MemberCount"]
                };
                ...
                if (reader["TopRegionId"] != DBNull.Value)
                {
                    supplier.TopRegionId = (int) reader["TopRegionId"];
                }
                if (reader["RegionId"] != DBNull.Value)
                {
                    supplier.RegionId = (int) reader["RegionId"];
                }
                if (reader["RelName"] != DBNull.Value)
                {
                    supplier.RealName = (string) reader["RealName"];
                }
                if (reader["CompanyName"] != DBNull.Value)
                {
                ...
                if (reader["Zipcode"] != DBNull.Value)
                {
                    supplier.Zipcode = (string) reader["Zipcode"];
                }
                if (reader["Phone"] != DBNull.Value)
                {
                    supplier.TelPhone = (string) reader["TelPhone"];
                }
                if (reader["CellPhone"] != DBNull.Value)
                {
                    supplier.CellPhone = (string) reader["CellPhone"];
                }
                if (reader["QQ"] != DBNull.Value)
                {
                    supplier.QQ = (string) reader["QQ"];
                }
                if (reader["Wangwang"] != DBNull.Value)
                {
                    supplier.Wangwang = (string) reader["Wangwang"];
                }
                if (reader["MSN"] != DBNull.Value)
                {
                    supplier.MSN = (string) reader["MSN"];
                }
                if (reader["Remark"] != DBNull.Value)
                {
                    supplier.Remark = (string) reader["Remark"];
                }
                if (reader["BnessCode"] != DBNull.Value)
                {
                    supplier.BnessCode = (string) reader["BnessCode"];
                }
                if (reader["ShuiwuCode"] != DBNull.Value)
                {
                    supplier.ShuiwuCode = (string) reader["ShuiwuCode"];
                }
                if (reader["Email"] != DBNull.Value)
                {
                    supplier.Email = (string) reader["Email"];
                }
                if (reader["ZuzhijgCode"] != DBNull.Value)
                {
                    supplier.ZuzhijgCode = (string) reader["ZuzhijgCode"];
                }
                if (reader["BankName"] != DBNull.Value)
                {
                    supplier.BankName = (string) reader["BankName"];
                }
                if (reader["BankCode"] != DBNull.Value)
                {
                    supplier.BankCode = (string) reader["BankCode"];
                }
                if (reader["SupplierId"] != DBNull.Value)
                {
                    supplier.SupplierId = (string) reader["SupplierId"].ToString();
                }
                if (reader["Supplierpwd"] != DBNull.Value)
                {
                    supplier.Supplierpwd = (string) reader["Supplierpwd"].ToString();
                }
                if (reader["ThreeCertificateImg"] != DBNull.Value)
                {
                    supplier.ThreeCertificateImg = (string) reader["ThreeCertificateImg"].ToString();
                }
            }
            return supplier;
        }
        ...
        public override SiteManager GetManager(HiMembershipUser membershipUser)
        {
            ...
            if (membershipUser.UserRole == UserRole.SiteManager)
            {
                DbCommand sqlStringCommand =
                    this.database.GetSqlStringCommand("SELECT COUNT(UserId) FROM aspnet_Managers WHERE UserId = @UserId");
                this.database.AddInParameter(sqlStringCommand, "UserId", DbType.Int32, membershipUser.UserId);
            ...
            else if (membershipUser.UserRole == UserRole.Supplier || membershipUser.UserRole == UserRole.Channel) //add 2014-7-9 供应商就不用判断aspnet_Managers表了
            {
                manager = new SiteManager(membershipUser);
            }
            return manager;
        ...
        public override Member GetMember(HiMembershipUser membershipUser)
        {
            Member member = null;
            DbCommand sqlStringCommand =
                this.database.GetSqlStringCommand("SELECT * FROM aspnet_Members WHERE UserId = @UserId");
            this.database.AddInParameter(sqlStringCommand, "UserId", DbType.Int32, membershipUser.UserId);
            using (IDataReader reader = this.database.ExecuteReader(sqlStringCommand))
            {
                if (!reader.Read())
        ...
        private void GetPasswordWithFormat(string tableName, string username, out bool success, out int passwordFormat,
            out string passwordSalt, out string passwordFromDb)
        {
            passwordFormat = 0;
            passwordSalt = null;
            passwordFromDb = null;
            ...
            DbCommand sqlStringCommand =
                this.database.GetSqlStringCommand(
                    "SELECT biz.TradePasswordFormat, biz.TradePasswordSalt, biz.TradePassword FROM " + tableName +
                    " AS biz INNER JOIN aspnet_Users AS u ON biz.UserId = u.UserId WHERE u.LoweredUserName = LOWER(@Username)");
            this.database.AddInParameter(sqlStringCommand, "Username", DbType.String, username);
            using (IDataReader reader = this.database.ExecuteReader(sqlStringCommand))
            {
                if (reader.Read())
        ...
        public override Member GetUnderling(HiMembershipUser membershipUser)
        {
            Member member = null;
            DbCommand sqlStringCommand =
                this.database.GetSqlStringCommand("SELECT * FROM distro_Members WHERE UserId = @UserId");
            this.database.AddInParameter(sqlStringCommand, "UserId", DbType.Int32, membershipUser.UserId);
            using (IDataReader reader = this.database.ExecuteReader(sqlStringCommand))
            {
                if (!reader.Read())
        ...
        public override bool UpdateSupplier(Supplier supplier)
        {
            DbCommand sqlStringCommand =
                this.database.GetSqlStringCommand(
                    "UPDATE dbo.Hishop_Suppliers SET SupplierName = @SupplierName ,SupplierId = @SupplierId ,Supplierpwd = @Supplierpwd,MemberCount = @MemberCount,BnessCode  = @BnessCode,Businesslicense = @Businesslicense,ShuiwuCode = @ShuiwuCode ,Shuiwu = @Shuiwu,ZuzhijgCode= @ZuzhijgCode,Zuzhijg = @Zuzhijg ,BankName = @BankName,BankCode= @BankCode,ThreeCertificateImg = @ThreeCertificateImg, GradeId = @GradeId, TopRegionId = @TopRegionId, RegionId = @RegionId, RealName = @RealName,CompanyName=@CompanyName, Address = @Address, Zipcode = @Zipcode,TelPhone = @TelPhone, CellPhone = @CellPhone, QQ = @QQ, Wangwang = @Wangwang, MSN = @MSN, Remark=@Remark,RequestRole=@RequestRole,RequestCode=@RequestCode,ApplyDate=@ApplyDate WHERE UserId = @UserId");
            string salt = UserHelper.CreateSalt();
            this.database.AddInParameter(sqlStringCommand, "UserId", DbType.Int32, supplier.UserId);
            this.database.AddInParameter(sqlStringCommand, "GradeId", DbType.Int32, supplier.GradeId);
            this.database.AddInParameter(sqlStringCommand, "TopRegionId", DbType.Int32, supplier.TopRegionId);
            ...
            this.database.AddInParameter(sqlStringCommand, "CompanyName", DbType.String, supplier.CompanyName);
            this.database.AddInParameter(sqlStringCommand, "Address", DbType.String, supplier.Address);
            this.database.AddInParameter(sqlStringCommand, "Zipcode", DbType.String, supplier.Zipcode);
            this.database.AddInParameter(sqlStringCommand, "TelPhone", DbType.String, supplier.TelPhone);
            this.database.AddInParameter(sqlStringCommand, "CellPhone", DbType.String, supplier.CellPhone);
            this.database.AddInParameter(sqlStringCommand, "QQ", DbType.String, supplier.QQ);
            this.database.AddInParameter(sqlStringCommand, "Wangwang", DbType.String, supplier.Wangwang);
            this.database.AddInParameter(sqlStringCommand, "MSN", DbType.String, supplier.MSN);
            this.database.AddInParameter(sqlStringCommand, "Remark", DbType.String, supplier.Remark);
            ...
            this.database.AddInParameter(sqlStringCommand, "MemberCount", DbType.Int32, supplier.MemberCount);
            this.database.AddInParameter(sqlStringCommand, "BnessCode", DbType.String, supplier.BnessCode);
            this.database.AddInParameter(sqlStringCommand, "Businesslicense", DbType.String, supplier.Businesslicense);
        ...
        public bool UpdateSupplier_Yi_Union(Supplier supplier)
        {
            DbCommand sqlStringCommand =
                this.database.GetSqlStringCommand(
                    "UPDATE dbo.Hishop_Suppliers SET SupplierName = @SupplierName ,SupplierId = @SupplierId ,Supplierpwd = @Supplierpwd,MemberCount = @MemberCount,BnessCode  = @BnessCode,Businesslicense = @Businesslicense,ShuiwuCode = @ShuiwuCode ,Shuiwu = @Shuiwu,ZuzhijgCode= @ZuzhijgCode,Zuzhijg = @Zuzhijg ,BankName = @BankName,BankCode= @BankCode,ThreeCertificateImg = @ThreeCertificateImg, GradeId = @GradeId, TopRegionId = @TopRegionId, RegionId = @RegionId, RealName = @RealName,CompanyName=@CompanyName, Address = @Address, Zipcode = @Zipcode,TelPhone = @TelPhone, CellPhone = @CellPhone, QQ = @QQ, Wangwang = @Wangwang, MSN = @MSN, Remark=@Remark,RequestRole=@RequestRole,RequestCode=@RequestCode,ApplyDate=@ApplyDate,IdentityCardNum=@IdentityCardNum,IdentityCardImg=@IdentityCardImg,ShopTitleImg=@ShopTitleImg,ShopInnerImg=@ShopInnerImg WHERE UserId = @UserId");
            string salt = UserHelper.CreateSalt();
            this.database.AddInParameter(sqlStringCommand, "UserId", DbType.Int32, supplier.UserId);
            this.database.AddInParameter(sqlStringCommand, "GradeId", DbType.Int32, supplier.GradeId);
            this.database.AddInParameter(sqlStringCommand, "TopRegionId", DbType.Int32, supplier.TopRegionId);
        ...
        public bool UpdateSupplier_Yi(Supplier supplier)
        {
            DbCommand sqlStringCommand =
                this.database.GetSqlStringCommand(
                    "UPDATE dbo.Hishop_Suppliers SET SupplierName = @SupplierName ,SupplierId = @SupplierId ,Supplierpwd = @Supplierpwd,MemberCount = @MemberCount,BnessCode  = @BnessCode,Businesslicense = @Businesslicense,ShuiwuCode = @ShuiwuCode ,Shuiwu = @Shuiwu,ZuzhijgCode= @ZuzhijgCode,Zuzhijg = @Zuzhijg ,BankName = @BankName,BankCode= @BankCode,ThreeCertificateImg = @ThreeCertificateImg, GradeId = @GradeId, TopRegionId = @TopRegionId, RegionId = @RegionId, RealName = @RealName,CompanyName=@CompanyName, Address = @Address, Zipcode = @Zipcode,TelPhone = @TelPhone, CellPhone = @CellPhone, QQ = @QQ, Wangwang = @Wangwang, MSN = @MSN, Remark=@Remark,RequestRole=@RequestRole,RequestCode=@RequestCode,ApplyDate=@ApplyDate WHERE UserId = @UserId");
        ...
        public override bool UpdateMember(Member member)
        {
            DbCommand sqlStringCommand =
                this.database.GetSqlStringCommand(
                    "UPDATE aspnet_Members SET GradeId = @GradeId,Points=@Points, IsOpenBalance = @IsOpenBalance, TopRegionId=@TopRegionId, RegionId = @RegionId, RealName = @RealName, Address = @Address, Zipcode = @Zipcode, TelPhone = @TelPhone, CellPhone = @CellPhone, QQ = @QQ, Wangwang = @Wangwang, MSN = @MSN WHERE UserId = @UserId");
        ...
        public override bool UpdateUnderling(Member underling)
        {
            DbCommand sqlStringCommand =
                this.database.GetSqlStringCommand(
                    "UPDATE distro_Members SET GradeId = @GradeId,IsOpenBalance = @IsOpenBalance, TopRegionId=@TopRegionId, RegionId = @RegionId, RealName = @RealName, Address = @Address, Zipcode = @Zipcode, TelPhone = @TelPhone, CellPhone = @CellPhone, QQ = @QQ, Wangwang = @Wangwang, MSN = @MSN WHERE UserId = @UserId");
            string str = UserHelper.CreateSalt();
            this.database.AddInParameter(sqlStringCommand, "UserId", DbType.Int32, underling.UserId);
            this.database.AddInParameter(sqlStringCommand, "GradeId", DbType.Int32, underling.GradeId);
