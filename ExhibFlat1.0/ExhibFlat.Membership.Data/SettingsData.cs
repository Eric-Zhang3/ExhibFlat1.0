namespace ExhibFlat.Membership.Data
{
    ...
    public class SettingsData : SiteSettingsProvider
    {
        ...
        public override void SaveDistributorSettings(SiteSettings settings)
        {
            ...
            this.database.AddInParameter(sqlStringCommand, "IsShowGroupBuy", DbType.Boolean, settings.IsShowGroupBuy);
            this.database.AddInParameter(sqlStringCommand, "IsShowCountDown", DbType.Boolean, settings.IsShowCountDown);
            this.database.AddInParameter(sqlStringCommand, "IsShowOnlineGift", DbType.Boolean, settings.IsShowOnlineGift);
