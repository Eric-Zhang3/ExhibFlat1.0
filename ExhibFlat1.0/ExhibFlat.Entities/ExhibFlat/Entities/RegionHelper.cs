namespace ExhibFlat.Entities
{
    ...
    public static class RegionHelper
    {
        ...
        /// <returns></returns>
        public static string GetParentNode(int currentRegionId)
        {
            System.Xml.XmlNode node = FindNode(currentRegionId);
            if (node == null)
            {
            ...
            return node.ParentNode.ParentNode.Attributes["name"].Value + "|" + node.ParentNode.Attributes["name"].Value + "|" + node.Attributes["name"].Value; 
        }
