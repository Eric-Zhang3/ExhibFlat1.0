namespace ExhibFlat.Entities.Promotions
{
    ...
    public class CouponInfo
    {
        ...
        [ValidatorComposition(CompositionType.Or, Ruleset="ValCoupon", MessageTemplate="满足金额，金额大小0.01-1000万之间"), RangeValidator(typeof(decimal), "0.01", RangeBoundaryType.Inclusive, "10000000", RangeBoundaryType.Inclusive, Ruleset="ValCoupon"), NotNullValidator(Negated=true, Ruleset="ValCoupon")]
