namespace ExhibFlat.Components.Validation
{
    ...
    {
        private ExhibFlat.Components.Validation.MemberValueAccessBuilder valueAccessBuilder;

        public MemberAccessValidatorBuilderFactory() : this(new ReflectionMemberValueAccessBuilder())
        {
        }

        public MemberAccessValidatorBuilderFactory(ExhibFlat.Components.Validation.MemberValueAccessBuilder valueAccessBuilder)
        {
        ...
        public ExhibFlat.Components.Validation.MemberValueAccessBuilder MemberValueAccessBuilder
        {
            get
            {
