namespace ExhibFlat.Components.Validation.Validators
{
    ...
    public class RegexValidator : ValueValidator<string>
    {
        ...
        public RegexValidator(string pattern, RegexOptions options) : this(pattern, options, (string) null)
        {
        }
        ...
        public RegexValidator(string patternResourceName, Type patternResourceType, RegexOptions options) : this(patternResourceName, patternResourceType, options, (string) null)
        {
        }
