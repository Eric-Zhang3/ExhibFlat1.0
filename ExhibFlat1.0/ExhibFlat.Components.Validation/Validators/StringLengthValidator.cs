namespace ExhibFlat.Components.Validation.Validators
{
    ...
    public class StringLengthValidator : ValueValidator<string>
    {
        ...
        public StringLengthValidator(int lowerBound, RangeBoundaryType lowerBoundType, int upperBound, RangeBoundaryType upperBoundType) : this(lowerBound, lowerBoundType, upperBound, upperBoundType, (string) null)
        {
        }
