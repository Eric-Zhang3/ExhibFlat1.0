namespace ExhibFlat.Membership.Core
{
    ...
    {
        private static readonly MemberRoleProvider _defaultInstance = (DataProviders.CreateInstance("ExhibFlat.Membership.Data.RoleData,ExhibFlat.Membership.Data") as MemberRoleProvider);
